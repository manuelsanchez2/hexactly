...
const LevelDef LEVELS[] = {
    ...
    // --- Bombs (21-25): close out the Beginner tier.

    { "short fuse", 4, 5,
      { {0,0,2,0}, {1,0,2,0}, {2,0,4,0}, {3,0,8,0},
        {4,0,16,F_GOAL,32} },
      0, {},
      0, {},
      1, { {2,-1, 4} } },

    { "eye of the storm", 5, 6,
      { {-2,2,8,0}, {-1,0,4,0}, {-1,1,4,0}, {0,-1,8,0},
        {0,0,4,F_GOAL,32}, {1,0,4,0} },
      0, {},
      0, {},
      1, { {1,-1, 8} } },
    ...
    { "care package", 5, 6,
      { {0,0,2,0}, {1,0,2,0}, {2,0,2,0}, {3,0,2,0},
        {5,-1,8,0}, {6,-2,16,F_GOAL,32} },
      0, {},
      1, { {2,0, 5,-1} },
      1, { {6,-1, 16} } },

    { "bunker", 5, 6,
      { {0,0,2,0}, {1,0,2,0}, {2,0,4,F_GOAL,16}, {3,0,2,0},
        {4,-1,4,0}, {4,0,2,0} },
      1, { {2,-1, 1,0} },
      0, {},
      1, { {2,-1, 8} } },
    ...
    { "crossfire", 5, 6,
      { {-2,1,4,0}, {-1,1,4,0}, {0,0,8,F_GOAL,32}, {1,0,8,0},
        {2,0,4,0}, {3,-1,4,0} },
      0, {},
      0, {},
      2, { {-1,0, 8}, {1,-1, 16} } },

    // --- Advanced (26-35): each has exactly one solution
    //     and a move limit equal to the minimum number of merges. ---

    { "decoy", 5, 7,
      { {0,-1,2,0}, {0,0,2,0}, {1,-1,2,0}, {1,0,2,0},
        {2,-1,8,0}, {3,-2,16,F_GOAL,32}, {4,-2,16,0} },
      3, { {0,0, 0,-1}, {1,0, 1,-1}, {3,-2, 4,-2} },
      0, {} },

    { "far side", 6, 8,
      { {-1,0,2,0}, {-1,1,2,0}, {0,-1,2,0}, {0,0,2,0},
        {3,-1,8,0}, {3,0,16,0}, {4,-1,32,F_GOAL,64}, {4,0,8,0} },
      3, { {-1,1, -1,0}, {0,0, -1,0}, {3,0, 4,-1} },
      1, { {0,0, 3,-1} } },

    { "quicksand", 6, 9,
      { {-1,1,2,0}, {-1,2,2,0}, {0,0,2,0}, {0,1,2,0},
        {1,-1,4,0}, {1,0,8,0}, {2,-1,4,0}, {2,0,16,0},
        {3,0,32,F_GOAL,64} },
      4, { {1,-1, 1,0}, {2,-1, 1,0}, {-1,2, 0,1}, {0,0, 1,0} },
      0, {} },

    { "needle", 9, 10,
      { {0,-1,2,0}, {0,0,2,0}, {1,-1,2,0}, {1,0,2,0},
        {2,-1,16,0}, {3,-2,32,F_GOAL,64}, {4,-3,2,0}, {4,-2,2,0},
        {5,-3,2,0}, {5,-2,2,0} },
      4, { {0,0, 0,-1}, {1,0, 1,-1}, {4,-2, 4,-3}, {5,-2, 5,-3} },
      1, { {1,-1, 4,-2} } },

    { "grand tour", 11, 13,
      { {-3,2,2,0}, {-2,-1,2,0}, {-2,0,2,0}, {-2,2,2,0},
        {-1,-1,2,0}, {-1,0,2,0}, {-1,1,4,0}, {-1,2,32,0},
        {0,0,32,F_GOAL,64}, {0,1,8,0}, {0,2,4,0}, {1,2,2,0},
        {2,2,2,0} },
      3, { {-2,-1, -2,0}, {-1,-1, -1,0}, {0,1, 0,0} },
      1, { {-2,0, -1,1} } },

    { "rosette", 7, 8,
      { {-1,0,2,0}, {-1,1,2,0}, {0,-1,2,0}, {0,0,2,F_GOAL,16},
        {0,1,2,0}, {1,-1,2,0}, {1,0,2,0}, {2,-1,2,0} },
      4, { {-1,0, -1,1}, {-1,0, 0,0}, {-1,1, 0,0}, {0,-1, 0,0} },
      0, {} },

    { "twin cities", 7, 8,
      { {-4,2,32,F_GOAL,64}, {-3,1,2,0}, {-3,2,2,0}, {-2,1,2,0},
        {-2,2,2,0}, {2,-1,8,0}, {3,-1,8,0}, {4,-2,8,0} },
      2, { {-2,1, -3,2}, {-3,1, -3,2} },
      2, { {-2,2, 2,-1}, {3,-1, -4,2} } },

    { "minefield", 8, 9,
      { {-2,1,4,0}, {-1,1,4,0}, {0,0,32,F_GOAL,64}, {0,1,4,0},
        {1,-2,4,0}, {1,-1,4,0}, {1,0,4,0}, {1,1,4,0},
        {2,0,4,0} },
      2, { {1,1, 1,0}, {0,0, 0,1} },
      0, {} },

    { "pinwheel", 6, 7,
      { {-2,2,4,0}, {-1,1,4,0}, {0,-2,8,0}, {0,-1,8,0},
        {0,0,4,F_GOAL,32}, {1,0,2,0}, {2,0,2,0} },
      0, {},
      0, {} },

    { "switchboard", 6, 7,
      { {-4,2,4,0}, {-3,1,4,0}, {0,-2,8,0}, {0,-1,8,0},
        {0,0,4,F_GOAL,32}, {3,1,2,0}, {3,2,2,0} },
      0, {},
      2, { {0,0, 3,1}, {0,0, -3,1} } },

    // --- Finale (36-40): bombs combined with walls and portals. Most use
    //     goalValue 0 (= merge EVERYTHING); several allow exactly one valid
    //     move ORDER, not just one solution set. Solver-verified (the FINALE
    //     list in tools/level_solver.py). ---

    { "checkpoint", 5, 6,
      { {0,0,2,0}, {0,1,2,0}, {1,0,4,0}, {5,0,8,0},
        {6,0,16,0}, {7,0,32,F_GOAL} },
      1, { {0,1, 1,0} },
      1, { {1,0, 5,0} },
      2, { {6,-1, 16}, {7,-1, 32} } },

    { "daisy chain", 5, 6,
      { {0,0,2,0}, {0,1,2,0}, {1,0,4,0}, {4,0,8,0},
        {5,0,16,0}, {6,0,32,F_GOAL} },
      2, { {1,-1, 0,0}, {5,-1, 4,0} },
      1, { {1,0, 4,0} },
      3, { {0,-1, 4}, {1,-1, 8}, {5,-1, 32} } },

    { "crossed wires", 6, 7,
      { {-4,0,2,0}, {-3,0,2,0}, {-3,1,2,0}, {-2,0,2,0},
        {-1,0,8,0}, {0,0,16,0}, {1,0,32,F_GOAL} },
      1, { {-3,0, -3,1} },
      0, {},
      2, { {0,-1, 16}, {1,-1, 32} } },
    ...
    { "slow burn", 8, 9,
      { {0,0,2,0}, {0,1,2,0}, {1,0,2,0}, {1,1,2,0},
        {2,0,4,0}, {2,1,4,0}, {3,0,8,0}, {3,1,8,0},
        {4,0,32,F_GOAL} },
      8, { {2,-1, 1,0}, {3,1, 4,0}, {0,0, 0,1}, {1,0, 1,1},
           {2,0, 2,1}, {0,1, 1,0}, {1,1, 2,0}, {2,1, 3,0} },
      0, {},
      1, { {2,-1, 8} } },

    { "powder keg", 8, 9,
      { {0,0,2,0}, {1,0,2,0}, {1,1,32,F_GOAL}, {2,0,4,0},
        {2,1,8,0}, {5,0,2,0}, {6,0,2,0}, {6,1,8,0},
        {7,0,4,0} },
      1, { {6,0, 6,1} },
      1, { {6,1, 2,1} },
      2, { {1,-1, 4}, {3,1, 16} } },
